...
function Mandrill(keys){
  ...
  this.send = function(data, callback) {
    ...
    var mandrillMessage = {
      ...
      'from_email': data.from || context.keys.from_email,
      'to': [
        {
          'email': data.to,
          'type': 'to'
    ...
    if(this.keys.subaccount) {
      mandrillMessage.subaccount = this.keys.subaccount;
    }
    if(data.from_name || context.keys.from_name) {
      mandrillMessage["from_name"] = data.from_name || context.keys.from_name;
    }
